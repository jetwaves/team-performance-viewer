...
.service('uibDateParser', ['$log', '$locale', 'orderByFilter', function($log, $locale, orderByFilter) {
  ...
  // Hack added by ssq.  from    bower_components/angular-bootstrap/ui-bootstrap-tpls.js
  ...
  this.convertTimezoneToLocal = function(date, timezone, reverse) {
      reverse = reverse ? -1 : 1;
  ...
  this.addDateMinutes = function (date, minutes) {
